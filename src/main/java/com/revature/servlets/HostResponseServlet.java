...
/**
 * Servlet implementation class HostResponseServlet
 */
public class HostResponseServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
       ...
       // req.getRequestDispatcher("HostConnectedServlet").forward(req, resp);
	}
